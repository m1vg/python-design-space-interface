...
class DisplayCase(object):
    ...
    def update_global_tolerances(self):
        ...
        html_str += '<tr ><th align=center  rowspan=2 style="padding:0 15px 0 15px;"> Parameters </th><th colspan=2> Tolerance </th><th></th></tr>'
        html_str += '<tr><td></td><td style="padding:0 15px 0 15px;"><b> Lower bound</b></td><td style="padding:0 15px 0 15px;"><b> Upper bound</b></td></tr>'
