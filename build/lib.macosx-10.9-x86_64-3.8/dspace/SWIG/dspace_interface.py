...
def dsCyclicalDesignSpaceCodominantCaseAdjustConditionMatrices_i(ds, aCase, case_sig_3d, factor, i, ineq_nr, ineq_nr_baseline_init, level):
    return _dspace_interface.dsCyclicalDesignSpaceCodominantCaseAdjustConditionMatrices_i(ds, aCase, case_sig_3d, factor, i, ineq_nr, ineq_nr_baseline_init, level)
