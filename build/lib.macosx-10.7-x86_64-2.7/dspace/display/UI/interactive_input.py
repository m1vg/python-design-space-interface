...
class InteractiveInput(object):
    ...
    def __init__(self, name='', version='', equations=None, conservations=None, parameters=None,
                 ...
                 codominance_adjust_boundaries=True,
        ...
        setattr(self, 'codominance_adjust_boundaries', codominance_adjust_boundaries)
    ...
    def edit_equations_widget(self, editing=False):
        ...
        codominance = Checkbox(description='Check for Co-dominance',
                               ...
                               visible=True)
        codominance_skip_phenotypes = Checkbox(description='Ignore Redundant Phenotypes',
                                               value=self.codominance_skip_overlapping,
                                               visible=False)
        codominance_adjust_boundaries = Checkbox(description='Adjust Boundaries',
                                               value=self.codominance_adjust_boundaries,
                                               visible=False)
        codominance_method = Dropdown(description='Method', value='Consider Mass Balances & Global Adjustments', #'Consider Mass Balances & Adjust Stoichiometry (new)'
                                      values=['Consider Mass Balances & Global Adjustments', #Consider Mass Balances & Adjust Stoichiometry (new)
                                              'Local Adjustments', # 'Adjust Stoichiometry (old)'
                                              'Do not Adjust Phenotypes'],
                                      options=['Consider Mass Balances & Global Adjustments', #Consider Mass Balances & Adjust Stoichiometry (new)
                                               'Local Adjustments', # 'Adjust Stoichiometry (old)'
                                               'Do not Adjust Phenotypes'],
                                      visible=False,
                                      )
        ...
        self.codominance_options = {'stoichiometry': self.codominance_adjust_stoichiometry,
                                    'skip': codominance_skip_phenotypes,
                                    'mass_balances': self.codominance_consider_mass_balances,
                                    'method': codominance_method,
                                    'adjust_boundaries': codominance_adjust_boundaries,
                                    'check_for_codominance': codominance}
    ...
    def update_codominance_options(self, name, value):
        ...
        if value == 'Consider Mass Balances & Global Adjustments': #'Consider Mass Balances & Adjust Stoichiometry (new)'
            b['stoichiometry'] = False
            b['mass_balances'] = True
            b['adjust_boundaries'].visible = True and self.codominance_options['check_for_codominance'].value is True
        elif value == 'Local Adjustments': # 'Adjust Stoichiometry (old)'
            b['stoichiometry'] = True
            b['mass_balances'] = False
            # b['adjust_boundaries'].visible = False
            # b['adjust_boundaries'].value = False
        else:
            b['stoichiometry'] = False
            b['mass_balances'] = False
            b['adjust_boundaries'].visible = False
    ...
    def adjust_codominance_options(self, name, value):
        ...
        b['adjust_boundaries'].visible = value and b['method'].value == \
                                         'Consider Mass Balances & Global Adjustments' # 'Consider Mass Balances & Adjust Stoichiometry (new)'
    ...
    def make_design_space(self, b):
        ...
        self.codominance_adjust_stoichiometry = b.codominance_options['stoichiometry']
        self.codominance_consider_mass_balances = b.codominance_options['mass_balances']
        self.codominance_skip_overlapping = b.codominance_options['skip'].value
        self.codominance_adjust_boundaries = b.codominance_options['adjust_boundaries'].value
        ...
        self.ds = dspace.DesignSpace(eq, name=b.name.value,
                                     ...
                                     codominance_adjust_boundaries=self.codominance_adjust_boundaries,
